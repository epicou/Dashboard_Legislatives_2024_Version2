...
# Liste des partis pour les pourcentages
partis = ['% RN', '% LFI', '% LR', '% ENS', '% DVG', '% REC', '% ECO',
          '% DVC', '% DVD', '% UDI', '% EXG', '% DIV', '% PS']

st.title("Carte interactive - Législatives 2024 Paris (Version 4.4)")
...
if len(votes_plot) == 0:
    ...
    # Sécuriser le hover_data pour n'utiliser QUE les colonnes "% ..." afin d'éviter la confusion avec "ENS" brut
    hover_data = {}
    for p in partis:
