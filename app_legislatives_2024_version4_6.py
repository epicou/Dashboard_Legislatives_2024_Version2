...
st.title("Carte interactive - Législatives 2024 Paris (Version 4.6)")
...
if len(votes_plot) == 0:
    ...
    # Choroplèthe d'abord pour qu'elle soit bien visible
    ...
    if len(geojson_dict["features"]) > 0:
        ...
        # Si pas de géométries, créer une figure vide
        fig = px.scatter_mapbox()

    # Ensuite on ajoute les points (scatter)
    ...
    # On ajoute les traces du scatter sur la figure choroplèthe
