...
st.title("Carte interactive - Législatives 2024 Paris (Version 5.2)")
...
# On fixe une taille de base et on multiplie par le % (valeurs de 0 à 1)
votes_plot["taille_points"] = votes_plot["% dominant"].fillna(0) * 50
votes_plot.loc[votes_plot["taille_points"] < 5, "taille_points"] = 5  # minimum

# ------------------------------
# Construction GeoJSON par IRIS
# ------------------------------
...
fig = px.choropleth_mapbox(
    ...
    hover_data={"IRIS": True, indicateur_selection: True}
)

# ---------------------------
# Scatter : points BV avec taille proportionnelle
# ---------------------------
