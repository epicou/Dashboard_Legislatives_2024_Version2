...
votes_df = pd.read_excel("Législatives 2024 Geo v1.0.xlsx", sheet_name="Votes")
iris_df = pd.read_excel("Législatives 2024 Geo v1.0.xlsx", sheet_name="IRIS_DISP")
...
st.title("Carte interactive - Législatives 2024 Paris (Version 3.1)")
...
# Correction : vérifier les colonnes existantes
...
if colonnes_existantes:
    ...
    taille_points = [10] * len(votes_plot)
