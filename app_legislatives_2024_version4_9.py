...
st.title("Carte interactive - Législatives 2024 Paris (Version 4.9)")
...
if len(votes_plot) == 0:
    ...
    # Infobulles propres : exclure LAT, LON et taille_points
    hover_data = {
        "Quartier": True,
        "ID_BVOTE": True,
        "LAT": False,
    ...
    # Préparation du GeoJSON sécurisé
    ...
    # Valeurs min/max pour la choroplèthe
