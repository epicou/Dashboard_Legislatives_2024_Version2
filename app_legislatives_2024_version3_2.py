...
votes_df = pd.read_excel("Legislatives_2024_Geo_v1_0.xlsx", sheet_name="Votes")
iris_df = pd.read_excel("Legislatives_2024_Geo_v1_0.xlsx", sheet_name="IRIS_DISP")
...
st.title("Carte interactive - Législatives 2024 Paris (Version 3.2)")
