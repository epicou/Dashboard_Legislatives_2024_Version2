...
# --- TITRE ---
st.title("Carte interactive - Législatives 2024 Paris — VERSION 7.2 — Folium améliorée")
...
votes_plot["taille_points"] = votes_plot["% dominant"].fillna(0) * 400
votes_plot.loc[votes_plot["taille_points"] < 20, "taille_points"] = 20
