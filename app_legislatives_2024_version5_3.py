...
st.title("Carte interactive - Législatives 2024 Paris (Version 5.3)")
...
# Taille proportionnelle au % du parti dominant
...
# -------------------------
# Préparation des info-bulles : top 3 partis
# -------------------------
def top3_partis(row):
    scores = {p.replace("% ", ""): row[p] for p in partis}
...
scatter = px.scatter_mapbox(
    ...
    mapbox_style="carto-positron",
    hover_name="Quartier",
    hover_data={"Quartier": False, "ID_BVOTE": False, "LAT": False, "LON": False, "taille_points": False},
