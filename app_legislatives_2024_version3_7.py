...
st.title("Carte interactive - Législatives 2024 Paris (Version 3.7)")
...
# Forcer LAT et LON à être numériques
votes_plot["LAT"] = pd.to_numeric(votes_plot["LAT"], errors="coerce")
votes_plot["LON"] = pd.to_numeric(votes_plot["LON"], errors="coerce")

# Supprimer les lignes sans coordonnées ou sans Parti dominant
votes_plot = votes_plot.dropna(subset=["LAT", "LON", "Parti dominant"])
...
# On force taille_points à être numérique
